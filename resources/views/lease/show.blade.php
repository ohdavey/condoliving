...
@section('content')
    <div class="container lease">
        ...
        <h2 class="page-header">
            ...
            <span class="pull-right label label-info">{{ $lease->statusText() }}</span>
        </h2>
        ...
        <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <label>Identification:</label> {{ $lease->tenant->personal_id }}<br>
            ...
            <div class="col-md-5">
                @if ($lease->property)
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-building-o"></i> <a href="{{ $lease->property->path() }}">Property Details</a></h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-6">

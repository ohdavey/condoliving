                        ...
                        <form method="POST" action="/lease">
                                    ...
                                    @else
                                        <div class="well well-sm">
                                            @foreach ($properties as $property)
                                                ...
                                                <i class="fa fa-check"></i> {{ $property->unit }} | {{ $property->address }} - ${{ $property->price }}
                                            @endforeach
                                        </div>
                                    @endif
                                </div>
                            ...
                            <lease inline-template v-cloak>
                                <fieldset id="tenant" class="row">
                                    ...
                                    <div id="ssn-check" class="col-lg-6">
                                        <label for="tenantEntryNew">Check for pre-existing tenants first:</label>
                                        <div class="input-group">
                                            <input type="text" name="ssnumber" id="ssnumber" v-model="ssnumber" class="form-control" placeholder="SSN or ID">
                                    ...
                                    <div class="tenant-entry-new">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="first_name" name="first_name"  v-model="tenant.first_name" placeholder="First" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-7">
                                            <div class="form-group">
                                                <label for="last_name">&nbsp;</label>
                                                <input type="text" class="form-control" id="last_name" name="last_name"  v-model="tenant.last_name" placeholder="Last" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-7">
                                            <div class="form-group">
                                            ...
                                            <span class="input-group-addon" id="basic-addon1"><i
                                                    ...
                                                    <input type="text" class="form-control" id="email" name="email"  v-model="tenant.email" placeholder="john@example.com" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
                                            ...
                                            <span class="input-group-addon" id="basic-addon1"><i
                                                    ...
                                                    <input type="text" class="form-control" id="phone" name="phone"  v-model="tenant.phone" placeholder="809-123-3000" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-7">
                                            ...
                                            <span class="input-group-addon" id="basic-addon1"><i
                                                    ...
                                                    <input type="text" class="form-control" id="ssn" name="ssn"  v-model="tenant.ssn" placeholder="State Id" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
                                            ...
                                            <span class="input-group-addon" id="basic-addon1"><i
                                                    ...
                                                    <input type="date" class="form-control" id="dob" name="dob"  v-model="tenant.dob" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="salary" name="salary"  v-model="tenant.salary" placeholder="0.00" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
